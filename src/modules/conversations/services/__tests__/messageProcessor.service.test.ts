...
describe('MessageProcessor - QR handling', () => {
  ...
  it('generates QR code with .qr command', async () => {
  ...
  it('throws an error when .qr is called without text', async () => {
  ...
  it('throws an error when QR service returns an error', async () => {
    ...
    await expect(
      processor.processAssistantMessage('.qr https://example.com', 99)
